        ...
        {   
            ...
            services.AddResponseCompression( opt => {
               // opt.Providers.Add<GzipCompressionProvider>();
                opt.Providers.Add<BrotliCompressionProvider>();//outro algoritmo de compressão mais eficiente
            ...
            {   
                ...
                foreach (var item in provider.ApiVersionDescriptions)
                {
                     ...
                     new Info { Title = $"API de Produtos {item.ApiVersion}", Version = item.ApiVersion.ToString() });
                }
